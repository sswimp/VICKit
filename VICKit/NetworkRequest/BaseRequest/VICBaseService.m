...
//        });
        [[WWJ_SVProgressHUD sharedHUD] show];
    }
...
//                    hud.detailsLabelText = [NSString stringWithFormat:@"%@",[responseDic valueForKey:@"result"]];
//                    [hud hide:YES afterDelay:1.0];
                    [[WWJ_SVProgressHUD sharedHUD] showErrorWithStatus:[NSString stringWithFormat:@"%@",[responseDic valueForKey:@"result"]] afterDelay:1];
                });
            }
...
//                hud.labelText = @"";
//                hud.detailsLabelText = [NSString stringWithFormat:@"%@",errorMsg];
//                hud.mode = MBProgressHUDModeText;
//                [hud hide:YES afterDelay:1.0];
                [[WWJ_SVProgressHUD sharedHUD] showErrorWithStatus:[NSString stringWithFormat:@"%@",errorMsg] afterDelay:1];
            });
        }
