...
//屏幕中间
#define Toast_Default_Bottom(title,mesg) {WJToast *toast = [[WJToast alloc]initToastWithTitle:title message:mesg iconImage:nil];toast.toastPosition = WJToastPositionBottomWithFillet;[toast show];}
#define Toast_Success_Bottom(title,mesg) {WJToast *toast = [[WJToast alloc]initToastWithTitle:title message:mesg iconImage:nil];toast.toastType = WJToastTypeSuccess;toast.toastPosition = WJToastPositionBottomWithFillet;[toast show];}
#define Toast_Error_Bottom(title,mesg) {WJToast *toast = [[WJToast alloc]initToastWithTitle:title message:mesg iconImage:nil];toast.toastType = WJToastTypeError;toast.toastPosition = WJToastPositionBottomWithFillet;[toast show];}
#define Toast_Warning_Bottom(title,mesg) {WJToast *toast = [[WJToast alloc]initToastWithTitle:title message:mesg iconImage:nil];toast.toastType = WJToastTypeWarning;toast.toastPosition = WJToastPositionBottomWithFillet;[toast show];}
#define Toast_Info_Bottom(title,mesg) {WJToast *toast = [[WJToast alloc]initToastWithTitle:title message:mesg iconImage:nil];toast.toastType = WJToastTypeInfo;toast.toastPosition = WJToastPositionBottomWithFillet;[toast show];}
